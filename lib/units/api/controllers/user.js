...
function addUserDevice(req, res) {
  var body = Object.hasOwnProperty.call(req, 'body')
  var serial = body ? req.body.serial : req.swagger.params.serial.value
  var timeout = body ? req.body.timeout ||
